                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {profile?.plan?.toLowerCase() === "basic" ? (
                      <a
                        href="https://github.com/MahammadHafeezJamadar/toolbazzar-extesion/raw/main/ToolsBazzar-Basic-v1%20(1).zip"
                        download
                      ...
                      <a
                        href="https://github.com/MahammadHafeezJamadar/toolbazzar-extesion/raw/main/ToolsBazzar-Pro-v1.zip"
                        download
                        className="h-10 rounded-lg border text-xs font-medium flex items-center justify-center gap-1.5 hover:bg-[#1a1a1a] transition-colors"
                        style={{ borderColor: "#1e1e1e", color: "#999" }}
                      >
